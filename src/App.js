...
class App extends Component {
  ...
  studentCall = () => {
    return fetch(
      `https://salty-hamlet-89842.herokuapp.com/api/v1/students/${
        this.state.userId
      }`
    )
      .then(resp => resp.json())
  ...
  handleClick = id => {
    this.props.history.push(`/teachers/${id}/availabilities/18022019`);
  };
  handleCardValue = event => {
      ...
      <div className="App">
        ...
        <Switch>
          ...
          <Route
            ...
            path="/login"
            component={routerProps => (
              <LogIn login={this.login} {...routerProps} />
            )}
          />
          <Route
            exact
            ...
            component={routerProps => (
              <Main
                ...
                handleCardValue={this.handleCardValue}
                {...routerProps}
              />
            )}
          />
          <Route
            ...
            component={routerProps => (
              <Teachers
                ...
                fetchteacher={this.fetchTeacher}
                callAvailabilities={this.callAvailabilities}
          ...
          <Route
            ...
            component={routerProps => (
              <Lessons
                studentLessons={this.state.student_login}
                username={this.state.username}
                studentCall={this.studentCall}
                {...routerProps}
              />
          ...
          <Route
            exact
            path="/teachers/:id/availabilities/:date"
            component={routerProps => (
              <Availabilities
                studentId={this.state.userId}
                availableState={this.state.availabilities}
                callAvailabilities={this.callAvailabilities}
                {...routerProps}
              />
            )}
          ...
          <Route
            exact
            path="/teachers/:id/availabilities/:date"
            component={routerProps => <Availability {...routerProps} />}
          />
