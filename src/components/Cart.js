...
class EnhancedTable extends React.Component {
  ...
  handleSelectAllClick = event => {
    if (event.target.checked) {
      this.setState(state => ({ selected: state.test.map(n => n.id) }));
      return;
    }
        ...
        <Paper className={classes.root}>
          ...
          <div className={classes.tableWrapper}>
            <Table className={classes.table} aria-labelledby="tableTitle">
              ...
              />
              <TableBody>
                {stableSort(test, getSorting(order, orderBy))
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          {n.availability.duration}
                        </TableCell>
                        <TableCell align="right">
                          {n.teacher.username}
                        </TableCell>
                        <TableCell align="right">{n.student_id}</TableCell>
                      </TableRow>
                    );
                  })}
                {emptyRows > 0 && (
