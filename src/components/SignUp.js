...
class Login extends Component {
  ...
  render() {
    ...
    return <div className="userSignIn">
        <TextField id="usernameInput" label="Username" value={username //   fullWidth='true'
          } onChange={handleChange} margin="normal" name="username" />
        <br />
        ...
        <br />
        <TextField id="imageInput" label="Image" value={image} onChange={handleChange} margin="normal" name="image" />
        <br />
        ...
        <Button variant="contained" color="secondary" onClick={() => this.handleClick()}>Teacher?</Button>
      </div>;
  }
}
